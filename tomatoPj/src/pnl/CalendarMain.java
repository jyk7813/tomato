...
public class CalendarMain extends JPanel implements ActionListener {
	...
	public CalendarMain() {
		...
		JPanel printCalPnl = new JPanel();
		printCalPnl.setBounds(0, 0, 857, 870);
		printCalPnl.setLayout(null);
		printCalPnl.setOpaque(false);
		...
		mainFrame.add(BorderLayout.NORTH, pane);
		pane2.add(title, "North");
		pane2.add(datePane);
		mainFrame.add(BorderLayout.CENTER, pane2);
